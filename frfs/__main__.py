...
from frfs.backends import BaseBackend, get_backend
from frfs.inifile import Inifile
from frfs.mpiutil import register_finalize_handler
from frfs.partitioners import BasePartitioner, get_partitioner
from frfs.rank_allocator import get_rank_allocation
from frfs.readers import BaseReader, get_reader_by_name, get_reader_by_extn
from frfs.readers.native import NativeReader
from frfs.solvers import get_solver
from frfs.util import subclasses
from frfs.writers import BaseWriter, get_writer_by_name, get_writer_by_extn


def main():
    ap = ArgumentParser(prog='frfs')
    ...
    ap_import.add_argument('outmesh', help='output FRFS mesh file')
    ...
    ap_export.add_argument('meshf', help='FRFS mesh file to be converted')
    ap_export.add_argument('solnf', help='FRFS solution file to be converted')
...
def process_import(args):
    ...
    # Get the mesh in the FRFS format
    mesh = reader.to_frfsm()
