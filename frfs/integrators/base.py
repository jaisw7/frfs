...
from frfs.plugins import get_plugin
...
class BaseIntegrator(object):
    ...
    def _copy_to_reg_dgfs(self, *args):
        # Get a suitable set of axnpby kernels
        copy = self._get_copy_to_reg_kerns(*args[:2])
    ...
    def _copy_from_reg_dgfs(self, *args):
        # Get a suitable set of axnpby kernels
        copy = self._get_copy_from_reg_kerns(*args[:2])
    ...
    def _add_dgfs(self, *args):
        # Get a suitable set of axnpby kernels
        # Bank indices are in odd-numbered arguments
        axnpby = self._get_axnpby_kerns_dgfs(args[1::2])
