...
class DGFSBiIntInters(BaseInters):
    def __init__(self, be, lhs, rhs, elemap, cfg, vm=None):
        ...
        # Added for dgfsbi
        self._be.pointwise.register('frfs.solvers.dgfsbi.kernels.intcflux')
...
class DGFSBiMPIInters(BaseInters):
    # Tag used for MPI
    MPI_TAG = 2314
    ...
    def __init__(self, be, lhs, rhsrank, rallocs, elemap, cfg, vm=None):
        ...
        # Added for dgfsbi
        self._be.pointwise.register('frfs.solvers.dgfsbi.kernels.mpicflux')
...
class DGFSBiBCInters(BaseInters):
    type = None
...
class DGFSBiWallDiffuseBCInters(DGFSBiBCInters):
    ...
    def __init__(self, be, lhs, elemap, cfgsect, cfg, **kwargs):
        ...
        for p in range(self._nspcs):
            self._d_bnd_f[p] = be.const_matrix(
                f[p].reshape(1, self._vm.vsize())
            );
        ...
        for p in range(self._nspcs):
            self._bcVals_lhs[p] = self._mat(lhs,
                'get_norm_pnorms_for_inter', initval=p)
        ...
        self.kernels['comm_flux0'] = lambda: self._be.kernel(
            ...
            cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
            cvz=self._vm.d_cvz(),
            bnd_f0=self._d_bnd_f[0], bc_vals=self._bcVals_lhs[0]
        )
        self.kernels['comm_flux1'] = lambda: self._be.kernel(
            ...
            cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
            cvz=self._vm.d_cvz(),
            bnd_f0=self._d_bnd_f[1], bc_vals=self._bcVals_lhs[1]
        )
...
class DGFSBiWallSpecularBCInters(DGFSBiBCInters):
    ...
    def __init__(self, be, lhs, elemap, cfgsect, cfg, **kwargs):
        ...
        # storage
        self._bcVals_lhs = [0]*self._nspcs
        for p in range(self._nspcs):
            self._bcVals_lhs[p] = be.matrix(f0.shape, f0)
        ...
        for p in range(self._nspcs): 
            self.kernels['comm_flux'+str(p+1)] = lambda: self._be.kernel(
                ...
                cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
                cvz=self._vm.d_cvz(), 
                bnd_f0=self._d_bnd_f0, bc_vals=self._bcVals_lhs[p]
            )

            self.kernels['update_bc'+str(p+1)] = lambda: self._be.kernel(
                'bccupdate', tplargs, dims=[self.ninterfpts], 
                ul=self._scal_lhs,
                nl=self._norm_pnorm_lhs, ploc=self._ploc, 
                cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
        ...
        self.kernels['comm_flux0'] = lambda: self._be.kernel(
            ...
            cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
            cvz=self._vm.d_cvz(), 
            bnd_f0=self._d_bnd_f0, bc_vals=self._bcVals_lhs[0]
        )
        ...
        self.kernels['comm_flux1'] = lambda: self._be.kernel(
            ...
            cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
            cvz=self._vm.d_cvz(), 
            bnd_f0=self._d_bnd_f0, bc_vals=self._bcVals_lhs[1]
        )
...
class DGFSBiInletBCInters(DGFSBiBCInters):
    type = 'dgfsbi-inlet'
    ...
    def __init__(self, be, lhs, elemap, cfgsect, cfg, **kwargs):
        ...
        self.kernels['comm_flux0'] = lambda: self._be.kernel(
            ...
            cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
            cvz=self._vm.d_cvz(), 
            bnd_f0=self._d_bnd_f[0], bc_vals=self._bcVals_lhs
        )
        ...
        self.kernels['comm_flux1'] = lambda: self._be.kernel(
            ...
            cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
            cvz=self._vm.d_cvz(), 
            bnd_f0=self._d_bnd_f[1], bc_vals=self._bcVals_lhs
        )


class DGFSBiInletNormalShockBCInters(DGFSBiBCInters):
    type = 'dgfsbi-inlet-normalshock'
...
class DGFSBiOutletBCInters(DGFSBiBCInters):
    type = 'dgfsbi-outlet'
...
class DGFSBiVanishBCInters(DGFSBiBCInters):
    type = 'dgfsbi-vanish'
...
class DGFSBiWallDiffuseCylBCInters(DGFSBiBCInters):
    type = 'dgfsbi-wall-diffuse-cyl'
    ...
    def __init__(self, be, lhs, elemap, cfgsect, cfg, **kwargs):
        ...
        self.kernels['comm_flux0'] = lambda: self._be.kernel(
            ...
            cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
            cvz=self._vm.d_cvz(),
            bnd_f0=self._vm.d_cvz(), bc_vals=self._bcVals_lhs[0]
        )
        self.kernels['update_bc0'] = lambda: self._be.kernel(
            'bccupdate', tplargs, dims=[self.ninterfpts], 
            ul=self._scal_lhs,
        ...
        self.kernels['comm_flux1'] = lambda: self._be.kernel(
            ...
            cvx=self._vm.d_cvx(), cvy=self._vm.d_cvy(), 
            cvz=self._vm.d_cvz(),
            bnd_f0=self._vm.d_cvz(), bc_vals=self._bcVals_lhs[1]
        )
        self.kernels['update_bc1'] = lambda: self._be.kernel(
            'bccupdate', tplargs, dims=[self.ninterfpts], 
            ul=self._scal_lhs,
