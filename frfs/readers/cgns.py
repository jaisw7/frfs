...
from frfs.ctypesutil import load_library
from frfs.readers import BaseReader, NodalMeshAssembler
from frfs.readers.nodemaps import CGNSNodeMaps
...
class CGNSZoneReader(object):
    # CGNS element types to FRFS type (petype) and node counts
    cgns_map = {
...
class CGNSReader(BaseReader):
    ...
    # Mappings between the node ordering of FRFS and that of CGNS
