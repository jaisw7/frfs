H0 = 1e-3;  // non-dimensional length [m]
H = 1e-3/H0;  // height of the domain non-dimensionalized by H0
L = H;  //  length of the domain
...
nVertexX = 5;  // nVertexX-1 = Number of cells in the x-direction
nVertexY = 5;  // nVertexY-1 = Number of cells in the y-direction
